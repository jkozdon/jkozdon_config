...
--   adapters = {
--     acp = {
--       cursor_cli_agent = function()
--         return require("codecompanion.adapters").extend("claude_code", {
--           name = "cursor_cli_agent",
--           formatted_name = "Cursor CLI (agent)",
--           env = {
--             CURSOR_ACP_MODE = "default",
--             CURSOR_TOOL_APPROVAL = "all"
--           },
--           commands = {
--             default = {
--               "node",
--               "/Users/jkozdon/code/cursor-acp/dist/index.js"
--             },
--           },
--           defaults = {
...
--         })
--       end,
--       cursor_cli_plan = function()
--         return require("codecompanion.adapters").extend("claude_code", {
--           name = "cursor_cli_plan",
--           formatted_name = "Cursor CLI (plan)",
--           env = {
--             CURSOR_ACP_MODE = "plan",
--           },
--           commands = {
--             default = {
--               "node",
